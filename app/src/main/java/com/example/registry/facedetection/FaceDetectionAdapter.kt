...
class FaceDetectionAdapter(private val context: Context, private val faceDetectionModels: List<FaceDetectionModel>) : androidx.recyclerview.widget.RecyclerView.Adapter<FaceDetectionAdapter.FaceDetectionViewHolder>() {
